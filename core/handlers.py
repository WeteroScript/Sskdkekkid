...
from database.file_manager import load_users, save_users, load_settings, save_settings, load_promocodes, save_promocodes, load_inventory, save_inventory, load_business, save_business
...
from config import ADMIN_IDS, bot, logger, BUSINESS_CONFIG, CONTAINERS, MINE_RESOURCES, FARM_RESOURCES, PROMO_CHANNEL_ID
import random
import string
import uuid
...
def register_handlers(dp: Dispatcher):
    ...
    # Здесь нужно добавить все остальные обработчики:
    # - work_diver
    # - work_farmer
    # - farm_harvest
    # - mine_menu
