...
def register_handlers(dp: Dispatcher):
    ...
    async def give_car(message: types.Message):
        ...
        try:
            ...
            # Находим машину по ID или по названию
            car_name = None
            
            # Сначала ищем по ID (car_1, car_2 и т.д.)
            ...
            # Если не нашли по ID, ищем по названию (частичное совпадение)
            if not car_name:
    ...
    async def id_function_list(message: types.Message):
        ...
        try:
            text = (
                ...
                "• menubutton_8 - Бизнес\n"
                "• menubutton_9 - Казино\n"
                "• menubutton_10 - Аукцион\n"
                "• menubutton_11 - Статистика\n"
                "• menubutton_12 - Техподдержка\n\n"
                "**Казино:**\n"
                "• casinogame_1 - Кубик\n"
                "• casinogame_2 - Слоты\n"
                "• casinogame_3 - Мины\n\n"
    ...
    async def set_car_auction(message: types.Message):
        ...
        try:
            ...
            # Удаляем старые неактивные лоты
            lots = [lot for lot in lots if lot.get("active", True)]
